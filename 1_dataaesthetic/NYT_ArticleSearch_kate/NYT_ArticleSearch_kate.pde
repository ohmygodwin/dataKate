...
String apiKey = "75c7c51cad7d23541bb82084456dc379:14:69781041";
...
void setup() {
  ...
  int[] monkeyCounts = doASearchYears("\"riot gear\"", 2007, 2013);
  ...
  PrintWriter writer = createWriter("data/riotgear.csv");
